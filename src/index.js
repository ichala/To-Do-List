...
list.forEach((item) => {
  ...
  const NewItemHtml = `<div class='listinfos'><div class='checklist'> <input type='checkbox' name='${item.index}' id='${item.index}' ${item.completed && 'checked'}> </div><div class='checktitle'>${item.description}</div></div> <div class='darg'> <i class='fa-solid fa-ellipsis-vertical'></i></div>`;
